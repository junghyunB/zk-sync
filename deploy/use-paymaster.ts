...
const PAYMASTER_ADDRESS = process.env.OWNER_ACCOUNT || '';

// Put the address of the ERC20 token here:
const TOKEN_ADDRESS = "0xbaB1e66465B59DE504F52b64C2F6A2ebbe0eFC99";

function getToken(hre: HardhatRuntimeEnvironment, wallet: Wallet) {
  const artifact = hre.artifacts.readArtifactSync("HyeonERC20");
